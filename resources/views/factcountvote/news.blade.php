            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('factcountvote.storenews') }}" method="post" name="factcountvote"
                            id="factcountvote">
                            @csrf
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <select class="form-control js-example-basic-single2" id="tipenews" name="tipenews"
                                            onchange="" required>
                                            <option value="" selected>Seleccione...</option>
                                            <option value="1" selected>Referente Jurados</option>
                                            <option value="2" selected>Referente Votantes</option>
                                        </select>
