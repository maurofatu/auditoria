            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                          ...
                          <form action="{{ route('factcountvote.store') }}" method="post" name="factcountvote" id="factcountvote">
                            @csrf
                            ...
                            <div class="row justify-content-center">
                              ...
                              <div class="row justify-content-center mt-3">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                      <input class="form-control" type="number" name="countvotes" id="countvotes" required/>
                                      @error('countvotes')
                                        <small style="color: #FF0000"> {{ $message }} </small>
                                      @enderror
                                    </div>
